...
public class RestClient {
   ...
   // private String baseUrl = ConfigManager.get("baseUrl");
    ...
    private RequestSpecification setupRequest(Authentication authType, ContentType contentType) {
    ...
    public Response get(String endpoint, Map<String, String> queryParams, Map<String, String> pathParams, Authentication authType, ContentType contentType) {
    ...
    public <T> Response post(String endpoint, T body, Map<String, String> queryParams, Map<String, String> pathParams, Authentication authType, ContentType contentType) {
        RequestSpecification request = setupRequest(authType, contentType);
    ...
    // PUT request
    public <T> Response put(String endpoint, T body, Map<String, String> queryParams, Map<String, String> pathParams, Authentication authType, ContentType contentType) {
        RequestSpecification request = setupRequest(authType, contentType);
    ...
    // PATCH request
    public <T> Response patch(String endpoint, T body, Map<String, String> queryParams, Map<String, String> pathParams, Authentication authType, ContentType contentType) {
        RequestSpecification request = setupRequest(authType, contentType);
    ...
    // DELETE request
    public Response delete(String endpoint, Map<String, String> queryParams, Map<String, String> pathParams, Authentication authType, ContentType contentType) {
        RequestSpecification request = setupRequest(authType, contentType);
 ...
 // Add a method to handle POST requests with a file
    public Response postWithFile(String endpoint, File file, 
                                 ...
                                 Authentication authType, ContentType contentType) {
